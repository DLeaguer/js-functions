...
var sumpro = checkProduct();
console.log("sum * product: ", sumpro);
...
var proquo = checkQuotient();
console.log("proquo: ", proquo);
...
var ats = addThenSubtract(bango3, bango4, bango5);
console.log("addThenSubtract: ", ats);
...
var mtd = multiplyThenDivide(bango3, bango4, bango5);
console.log("multiplyThenDivide: ", mtd);
...
eatFood("Jeffrey", "Becera", "cereal");

var eatBFast = eatFood("Jeffrey", "Becera", "cereal");
console.log(eatBFast);
 ...
 * #18
 * Function - throwParty
 * Create a function named thr owParty. This function will check the value stored in the `canDrink` variable in the previous exercise. If the value is true, it will return the message "Cheee Hoo! We going to da party!" If false, then it will return the message "Meh, see you at Starbucks." Store the return value to a variable named `canParty`. Console.log your result.
 */
